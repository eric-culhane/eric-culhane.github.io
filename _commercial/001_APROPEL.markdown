...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); grid-gap: 10px;">
    ...
    <!-- Repeat this block with each video -->
    <div style="padding:177.78% 0 0 0;position:relative;">
        <iframe src="https://player.vimeo.com/video/1000?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="twenty"></iframe>
    </div>
    <!-- End of block -->
